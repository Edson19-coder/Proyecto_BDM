                            ...
                            <div class="col-12">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <p class="card-text" style="font-size: small;">19/09/2021</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <p class="card-text" style="font-size: small;">19/02/2021</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <p class="card-text" style="font-size: small;">XX/XX/XXXX</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
