...
<body>
    ...
    <input type="hidden" class="courseId" id="courseId" value="<?php echo $_GET['course'] ?>"></input>
    <!-- CONTENT -->
        ...
        <div class="row">
            ...
            <div class="col-2 options-list">
                <ul>
                    ...
                    <a class="nav-link" id="id-index-payment">Price</a>
                    <a class="nav-link" id="id-index-course-create">Edit</a>
                </ul>
            </div>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 text-end">
                                ...
                                <button type="submit" id="btn-edit-course" class="btn btn-primary">Edit</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="js/update-course.js"></script>
